...
INSERT INTO `alumno` (`curp`, `nombre`, `primer_apellido`, `segundo_apellido`, `genero`, `fecha_nacimiento`, `correo`, `telefono_celular`, `telefono_casa`, `direccion`, `contrasena`, `fecha_registro`) VALUES
('CEBO661126HDFRTS02', 'OSCAR', 'CERON', 'BAUTISTA', 'M', '2000-04-13', 'IAN.CR@OUTLOOK.COM', '5544562483', '', 'JACARANDAS, 27, RINCON VERDE, 53219, NAUCALPAN, ESTADO DE MEXICO', '202cb962ac59075b964b07152d234b70', '2021-01-21 18:04:24'),
('CERI000722HDFRVNA9', 'IAN', 'CERON', 'RIVERA', 'M', '2000-01-22', 'IAN.CR@OUTLOOK.COM', '5544562483', '', 'AVENIDA COLINAS, 73, COLINAS DE SAN MATEO, 53218, NAUCALPAN, ESTADO DE MEXICO', 'b6b14193371742ed98df722fd7d39fab', '2021-01-21 01:46:03'),
('CERI010622MDFRVTA6', 'ITZEL VALERIA', 'CERON', 'RIVERA', 'F', '2001-06-22', 'ZAIKKO_13@HOTMAIL.COM', '5544562483', '', 'ANDADOR CERROS DE JALAP, 93, COLINAS DE SAN MATEO, 53218, NAUCALPAN, ESTADO DE MEXICO', '202cb962ac59075b964b07152d234b70', '2021-01-21 17:26:21'),
('RIFG661026MDFVRL00', 'GUILLERMINA', 'RIVERA', 'FERNANDEZ', 'F', '2000-08-19', 'IAN.CR@OUTLOOK.COM', '5544562483', '', 'AVENIDA SUBESTACION, 45, COLINAS DE SAN MATEO, 53218, NAUCALPAN, ESTADO DE MEXICO', '202cb962ac59075b964b07152d234b70', '2021-01-21 18:47:10'),
('MEME000501HDFNRDA7', 'EDUARDO', 'MENDOZA', 'MARTÍNEZ', 'M', '2000-05-01', 'EMENDOZAM1501@ALUMNO.IPN.MX', '5619849863', '', 'GEOLOGÍA, 19, EL ROSARIO, 02100, AZCAPOTZALCO, CDMX', '7815696ecbf1c96e6894b779456d330e', '2021-01-21 21:36:08'),
('MEME891031HDFNTT63', 'EDGAR', 'MENDOZA', 'MARTÍNEZ', 'N', '1997-10-31', 'EDOOMM8@GMAIL.COM', '5560955432', '', 'MATEMATICAS, 56, EL ROSARIO, 02100, AZCAPOTZALCO, CDMX', 'b2ef9c7b10eb0985365f913420ccb84a', '2021-01-21 21:38:31'),
('MEME930611HDFNRDA7', 'ERICK', 'MENDOZA', 'MARTÍNEZ', 'M', '1998-08-11', 'EDURASTES123@GMAIL.COM', '5619849863', '', 'BIOLOGIA, 21, EL ROSARIO, 02100, AZCAPOTZALCO, CDMX', '7815696ecbf1c96e6894b779456d330e', '2021-01-21 21:25:29');

INSERT INTO `escuela` (`id_escuela`, `nombre`, `localidad`, `tipo`) VALUES
(33, 'EPO. 324', 'LOS REMEDIOS', 'BACHILLERATO GENERAL'),
(34, 'ERTO. 78', 'SAN JUAN', 'BACHILLERATO TÉCNICO');
...
INSERT INTO `alumno_has_escuela` (`curp_alumno`, `id_escuela`, `id_formacion_tecnica`, `promedio`) VALUES
('CERI000722HDFRVNA9', 3, 9, '8.4'),
('CERI010622MDFRVTA6', 33, NULL, '9.2'),
('CEBO661126HDFRTS02', 2, 1, '8'),
('RIFG661026MDFVRL00', 34, 31, '8.4'),
('MEME930611HDFNRDA7', 7, 19, '7.8'),
('MEME000501HDFNRDA7', 9, 13, '8.7'),
('MEME891031HDFNTT63', 12, 3, '6.8');

INSERT INTO `grupo` (`clave`, `horario`, `cupo`) VALUES
('1101-00', '2021-02-22 10:00:00', 20),
('1102-00', '2021-02-22 10:00:00', 20);

INSERT INTO `alumno_has_grupo` (`curp_alumno`, `clave_grupo`, `aciertos`) VALUES
('CERI000722HDFRVNA9', '1101-00', -1),
('CERI010622MDFRVTA6', '1101-00', -1),
('CEBO661126HDFRTS02', '1102-00', -1),
('RIFG661026MDFVRL00', '1101-00', -1),
('MEME930611HDFNRDA7', '1102-00', -1),
('MEME000501HDFNRDA7', '1102-00', -1),
('MEME891031HDFNTT63', '1102-00', -1);

INSERT INTO `alumno_has_programa` (`curp_alumno`, `semestre`, `id_programa_academico`, `opcion`) VALUES
('CERI000722HDFRVNA9', '2021-1', 1, 1),
('CERI010622MDFRVTA6', '2021-1', 3, 3),
('CEBO661126HDFRTS02', '2021-1', 2, 2),
('RIFG661026MDFVRL00', '2021-1', 1, 2),
('MEME930611HDFNRDA7', '2021-1', 2, 1),
('MEME000501HDFNRDA7', '2021-1', 1, 1),
('MEME891031HDFNTT63', '2021-1', 3, 1);
